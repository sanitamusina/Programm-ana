age_input = int(input("Ievadi savu vecumu: ").strip())
...
if age_input >= 21 and car_licence_input == "jā":
    ...
    print ("Tu nevari nomāt auto, jo tu neesi pietiekami vecs un tev nav autovadītāja apliecības.")

if age_input >=65 or veteran_input == "jā":
    print ("Tu vari saņemt seniora atlaidi")
else: 
    print ("Tu nekvalificējies seniora atlaidei")
...
if 16 <=age_input <= 26 and student_input == "jā":
    ...
    print ("Tu nevari saņemt studentu atlaidi, jo tu neesi vecumā no 16 līdz 26 gadiem un tu neesi students.")
