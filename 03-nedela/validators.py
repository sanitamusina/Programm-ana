...
if __name__ == "__main__":
    ...
    print(is_email("janisaule.lv"))
    print(is_email("janis@saule.ss"))
    print(is_phone_number("+271 11122233"))
    print(is_phone_number("+371 222122233"))
    print(is_phone_number("+371 11122233"))
    print(is_valid_age(125))
    print(is_valid_age(225))
    print(is_valid_age(-2))
    print(is_strong_password("123sanita"))
    print(is_strong_password("1sanita"))
    print(is_strong_password("acssanita"))
    print(is_valid_date("18-12-2025"))
    print(is_valid_date("33-12-2025"))
    print(is_valid_date("30-02-2025"))
    print(is_valid_date("3000-02-20"))
    print(is_valid_date("2025-02-20"))
